...
int main() {
    ...
    while (mainChar.Hp > 0) {
        ...
        cout << "Are you the run and gun type that acts instantly without thinking always just in time to save the day?\n" << endl;

        cout << "Or are you the type of player who likes to sit plan and take a more thoughtful approach to the current situation\n" << endl;

        cout << "Or are you a more balanced type that likes to switch it up?\n" << endl;
